...
import CategoryWeightsBoxplot from './CategoryWeightsBoxplot';

export default function CategoryWeightsContainer() {
  const { data, isLoading, isError } = useCategoryWeights();
  ...
  return <CategoryWeightsBoxplot data={data} />;
}
